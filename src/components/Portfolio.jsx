...
import TiltCard from './portfolio/TiltCard';
...
export default function Portfolio() {
  ...
  return (
    <main className={`min-h-screen overflow-x-hidden font-sans antialiased transition-colors duration-500 ${isDarkMode ? "bg-black text-white" : "bg-white text-black"}`}>
      
      <Navbar isDarkMode={isDarkMode} />
      
      {/* FIXED: Now Hero knows when to switch between black and white text */}
      <Hero isDarkMode={isDarkMode} />

      <Brands isDarkMode={isDarkMode} />

      {/* RESTORED: THEME TOGGLE: FIXED MIDDLE RIGHT */}
      <button 
      ...
      {/* QA FIX: Added the prop here so the Footer doesn't break in light mode later */}
