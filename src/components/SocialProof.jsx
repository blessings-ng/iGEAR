  ...
  return (
    <section className="relative w-full py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Two-Card Grid */}
        <div className="grid grid-cols-2 md:grid-cols-1 gap-8 mb-16 max-w-2xl items-center mx-auto">
          {/* Card 1: The Problem */}
          <div className="group relative p-8 rounded-3xl bg-gray-900/50 border border-blue-500/30 hover:border-blue-400 transition-all duration-300 overflow-hidden">
            {/* Card Glow Effect */}
